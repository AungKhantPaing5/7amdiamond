...
import { Loader2, Gem, Sparkles, Shield, ArrowRight, Eye, EyeOff } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="flex items-center justify-center min-h-screen p-4 relative z-10">
        <Card className="w-full max-w-lg bg-slate-800/90 border-slate-700/50 backdrop-blur-xl shadow-2xl shadow-purple-500/10">
          <CardHeader className="text-center pb-8 pt-12">
            ...
            <CardTitle className="text-white text-3xl font-bold mb-2">Welcome Back!</CardTitle>
            <CardDescription className="text-slate-400 text-lg">
              Sign in to access your diamond account and continue your Mobile Legends journey
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="px-8 pb-8">
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    className="bg-slate-700/50 border-slate-600/50 text-white placeholder-slate-400 focus:border-purple-500 focus:ring-purple-500/20 h-12 text-lg rounded-xl pr-12"
            ...
            <div className="my-8 flex items-center">
              ...
              <span className="px-4 text-slate-400 font-medium">New to 7AM Diamond?</span>
              <div className="flex-1 border-t border-slate-600"></div>
            </div>
            ...
            <div className="text-center">
              <p className="text-slate-400 mb-4">
                Join thousands of Mobile Legends players and get exclusive diamond deals!
              </p>
